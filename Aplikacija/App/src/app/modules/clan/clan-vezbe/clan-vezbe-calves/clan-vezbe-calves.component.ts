...
@Component({
  selector: 'app-clan-vezbe-calves',
  templateUrl: './clan-vezbe-calves.component.html',
  styleUrls: ['./clan-vezbe-calves.component.css']
})
export class ClanVezbeCalvesComponent implements OnInit {

  constructor(private clanService: ClanService, private safePipe:SafePipe) {}

  vezbe: Observable<Vezba[]> | null = null;
  ngOnInit(): void {
    this.vezbe=this.clanService.getVezbeCalves();
  }
}
