...
@Component({
  selector: 'app-clan-vezbe-glutes',
  templateUrl: './clan-vezbe-glutes.component.html',
  styleUrls: ['./clan-vezbe-glutes.component.css']
})
export class ClanVezbeGlutesComponent implements OnInit {

  constructor(private clanService: ClanService, private safePipe:SafePipe) {}

  vezbe: Observable<Vezba[]> | null = null;
  ngOnInit(): void {
    this.vezbe=this.clanService.getVezbeGlutes();
  }
}
