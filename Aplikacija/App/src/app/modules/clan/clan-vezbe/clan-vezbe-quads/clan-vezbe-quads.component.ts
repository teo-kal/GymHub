...
@Component({
  selector: 'app-clan-vezbe-quads',
  templateUrl: './clan-vezbe-quads.component.html',
  styleUrls: ['./clan-vezbe-quads.component.css']
})
export class ClanVezbeQuadsComponent implements OnInit {
  constructor(private clanService: ClanService, private safePipe:SafePipe) {}

  vezbe: Observable<Vezba[]> | null = null;
  ngOnInit(): void {
    this.vezbe=this.clanService.getVezbeQuads();
  }
}
